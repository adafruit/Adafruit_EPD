...
static const uint8_t ti_154m05_gray4_init_code[] {
    ...
    SSD1681_SOURCE_VOLTAGE, 3, 0x41, 0x00, 0x32,   // Set source voltage (GxEPD2 D67)
    SSD1681_WRITE_VCOM, 1, 0x1C,   // Vcom Voltage (GxEPD2 D67)
...
static const uint8_t ti_154m05_gray4_lut_code[] = {
  0x32, 153,
  // GxEPD2_154_GDEY0154D67 lut_4G: DC-balanced (0x48) fast 4-gray waveform
  // VS rows: L0 white, L1 light grey, L2 dark grey, L3 black, L4 vcom
